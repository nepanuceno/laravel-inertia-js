...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: {
    handleForm: function handleForm() {
      this.$inertia.post('/register', this.form); // alert("O Formulario foi enviado")
    }
  }
});
...
var render = function() {
  ...
  return _c("layout", [
    _c("div", [
      _vm._v("\n        Olá, " + _vm._s(_vm.user) + ", eu sou a HOME\n    ")
    ]),
    _vm._v(" "),
    _vm.flash.success
      ? _c(
    ...
    _vm.flash.error
      ? _c(
          "div",
          {
            staticClass: "alert alert-error alert-dismissible fade show",
            attrs: { role: "alert" }
          },
          [_vm._v("\n        " + _vm._s(_vm.flash.success) + "\n    ")]
        )
